...
export default function OrganizersListPage() {
  ...
  const itemListSchema = sortedOrganizers.length > 0 ? {
    ...
    "itemListElement": sortedOrganizers.map((organizer, index) => ({
      "@type": "ListItem",
      "position": index + 1,
      "url": `https://natureexplorers.gr/OrganizerProfile?organizer=${organizer.username}`,
              ...
              return (
                <Card key={organizer.id} className="text-center shadow-lg hover:shadow-xl transition-shadow flex flex-col h-full">
                  ...
                  <CardContent className="p-6 flex flex-col flex-grow">
                    ...
                    <Link to={`${createPageUrl("OrganizerProfile")}?organizer=${organizer.username}`} className="mt-auto">
